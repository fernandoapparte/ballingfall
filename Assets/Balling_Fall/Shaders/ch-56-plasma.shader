Shader "Holistic P2/ch-56-plasma" {
    Properties {
    ...
    SubShader {
      ...
      void surf (Input IN, inout SurfaceOutput o) {
		  ...
		  //According to https://www.udemy.com/course/unity-shaders/learn/lecture/8604300#questions/3818080
		  //Pi is already defined but it needs an include

		  //What is important here is _Time is a predefined variable we don't need to declare
		  //Most important variables are here//https://docs.unity3d.com/Manual/SL-UnityShaderVariables.html
