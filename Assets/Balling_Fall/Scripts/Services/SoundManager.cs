...
namespace BallingFallGame
{
    ...
    {
        public ScriptableObject soundManagerConfig; //Sound Manager Config
        public SoundManagerConfig SMC { private set; get; }
        ...
        void Start()
        {
            ...
            if (!soundManagerConfig.GetType().Equals(typeof(SoundManagerConfig)))
            {
                Debug.LogError("Incorrect Scriptable Object on Sound Manager Configuration!!!");
            }
            SMC = (SoundManagerConfig)soundManagerConfig;
            SetMute(IsMuted());
        }
        /*Playlist*/
        ...
        IEnumerator CRPlaySound(Sound sound, bool autoScaleVolume = true, float maxVolumeScale = 1f)
        {
            ...
            Debug.Log("simultaneous sounds:" + sound.simultaneousPlayCount);
            sound.simultaneousPlayCount--;
        }
