...
namespace BallingFallGame
{
    public class ShareManager : MonoBehaviour
    {
        ...
        {
            ScreenshotPath = Path.Combine(Application.persistentDataPath, appConfig.ScreenShotName);
#if UNITY_EDITOR
        ...
        {
            Share(appConfig.ShareText, ScreenshotPath, appConfig.AppUrl, appConfig.ShareSubject);
        }
        ...
        {
            Application.OpenURL(appConfig.TwitterAddress + "?text=" + WWW.EscapeURL(appConfig.TwitterTextToDisplay) 
                + "&amp;lang=" + WWW.EscapeURL(appConfig.TwitterLanguage));
        }
        ...
        public void FacebookShare()
        {
            ...
            {
                Application.OpenURL("https://www.facebook.com/dialog/feed?" + "app_id=" +appConfig.FbAppId + "&link=" 
                    + appConfig.AppUrl+ "&picture=" + appConfig.FbPictureUrl + "&caption=" + appConfig.FbSharedCaption 
                    + "&description=" +appConfig.FbDescription);
            }
            else
            {
                Application.OpenURL("https://www.facebook.com/dialog/feed?" + "app_id=" + appConfig.FbAppId
                  + "&link=" + appConfig.AppUrl + "&caption=" + appConfig.FbSharedCaption + "&description=" + appConfig.FbDescription);         
                    }
        }
